...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <form name="add" method="post" action="../phome/index.php" enctype="multipart/form-data">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25"> <p>上传文件:(*)</p></td>
      <td height="25"><input name="file" type="file" size="45"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25" valign="top">软件介绍:(*)</td>
      <td height="25"> <textarea name="softsay" cols="67" rows="10" style="WIDTH:100%"></textarea></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25">&nbsp;</td>
