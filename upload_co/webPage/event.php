...
<body>
    ...
    <main>
  <div class="banner" style="background-image:url(../../staticPoj/imgs/ban5.jpg);"></div>
  <div class="history">
    <div class="top">
      <h1 class="pgTitle">诚聪大事记</h1>
    </div>
    <div class="inner btm">

        <article class="item">
            <div class="time"> <i class="dot"></i>
                <time>2019</time>
            </div>
            <div class="text">
                <ul>
                    <li>
                        开发自适应学习系统，<br />运用大数据和强大的电子教学资源，<br />
                        为学生个性化高效学习服务
                    </li>
                </ul>
            </div>
