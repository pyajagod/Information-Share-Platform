...
<div id="main">
    ...
    <form name=alipayment id=dopaypost action=alipay/pagepay/pagepay.php method=post target="_self">
        <div id="body1" class="show" name="divcontent">
            <dl class="content" hidden>
                <dt>商户订单号
                    ：</dt>
                <dd>
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDtotal_amount").value = <?echo $v_amount; ?>;
    }
    GetDateNow();
