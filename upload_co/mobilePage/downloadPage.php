...
<div class="lay_all">
        <div class="lay_title card col-md-10">
            <div style="float: left">
                <img src="../imgs/erha1.png" style="height: 200px; width: 240px"/>
            </div>
            <?php
            ...
            ?>
                <div style="margin-left: 20px">
                    <span style="font-size: 50px"><?php echo $row['course_name']?></span>
                    <br/>
                    <span style="font-size: 38px">分类栏目：<?php echo $row['course_label']?></span>
                    <br/>
                    <span style="font-size: 30px">下载说明：请选择合适的视频开始下载</span>
                </div>
                </div>
        ...
        <div class="lay_down">
            <div id="page-inner">
                <div class="col-md-11 col-sm-6" style="width:100%;">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="col">
                                <ul class="tabs">
                                    <li class="tab col s3"><a style="font-size: 30px;" href="#test1">预习领先</a></li>
                                    <li class="tab col s3"><a style="font-size: 30px;" href="#test2">复习巩固</a></li>
                                    <li class="tab col s3"><a style="font-size: 30px;" href="#test3">拓展提优</a></li>
                                    <li class="tab col s3"><a style="font-size: 30px;" href="#test4">所有视频</a></li>
                                </ul>
                            </div>
                            <div class="clearBoth"><br/></div>
                            <div id="test1" class="col s12" style="font-size: 30px;">
                                <?php
                                    ...
                                    while ($row = $mysqli_result->fetch_array(MYSQLI_ASSOC)) {
                                        ...
                                        ?>
                                        <button type="button" class="layui-btn layui-btn-warm"><a style="font-size: 30px;" href="<?php echo $url;?>">预习视频</a></button>
                                        <span class="lay_ex" style="font-size: 30px;">
                            ...
                            <div id="test2" class="col s12">
                                ...
                                while ($row1 = $mysqli_result1->fetch_array(MYSQLI_ASSOC)) {
                                    ...
                                    ?>
                                    <button type="button" class="layui-btn layui-btn-warm"><a style="font-size: 30px;" href="<?php echo $url1;?>">复习视频</a></button>
                                    <span class="lay_ex" style="font-size: 30px;">
...
<!--                                    <button type="button" class="layui-btn layui-btn-warm">扩展视频</button>-->
                                    <button type="button" class="layui-btn layui-btn-warm"><a style="font-size: 30px;" href="<?php echo $url2;?>">扩展视频</a></button>
                                    <span class="lay_ex" style="font-size: 30px;">
...
<!--                                            路径：--><?php //echo $row2['path_id'] ?>
                            ...
                            <div id="test4" class="col s12">
                                <?php
                                $sql3 = "SELECT * FROM ccxm_path WHERE course_id = {$courseId} AND cate_log = 'all' ";
                                ...
                                while ($row3 = $mysqli_result3->fetch_array(MYSQLI_ASSOC)) {
                                    ...
                                    $url3 = '../DownVideo/index.php?' . http_build_query($query3);
                                    ?>
                                    <!--                                    <button type="button" class="layui-btn layui-btn-warm">扩展视频</button>-->
                                    <button type="button" class="layui-btn layui-btn-warm"><a style="font-size: 30px;" href="<?php echo $url3;?>">所有视频</a></button>
                                    <span class="lay_ex" style="font-size: 30px;">
                                            下载需要点数：<?php echo $row3['path_need_point'] ?>点
                                        <!--                                            路径：--><?php //echo $row2['path_id'] ?>
                                        </span><br/><br/>
                                    <?php
                                }
