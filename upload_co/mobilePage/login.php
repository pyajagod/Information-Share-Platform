    ...
    <div class="layui-anim layui-anim-up layui-anim-rotate">
      <div id="layout_all">
          ...
          <div id="layout_body">
              ...
              <form class="layui-form" name="loginmobile" action="../phome/index.php" method="post">
                  <input name="ecmsfrom" type="hidden"  value="<?=$from?>">
                  <input name="phome" type="hidden" id="phome" value="loginmobile">
                  <div class="layui-form-item">
                      <label class="layui-form-label"><span style="color: #00F7DE">用户名</span></label>
                      <div class="layui-input-inline">
                          <input style="width:200px;" type="text" id="userId" name="username" required  lay-verify="required" placeholder="请输入用户名" autocomplete="off" class="layui-input">
                      </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input style="width:200px;" type="password" id="userPwd" name="password" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                      </div>
