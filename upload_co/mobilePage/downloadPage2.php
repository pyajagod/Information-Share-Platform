        ...
        <div class="lay_title card col-md-10">
            ...
            ?>
                <div style="margin-left: 20px">
                    ...
                    <br/>
                    <span style="font-size: 38px">下载说明：请选择合适的视频开始下载</span>
                </div>
                </div>
                ...
                <div class="col-md-11 col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="col">
                                <ul class="tabs">
                                    <li class="tab col s3"><a style="font-size: 30px;" href="#test1">基础</a></li>
                                    <li class="tab col s3"><a style="font-size: 30px;" href="#test2">提高</a></li>
                                    <li class="tab col s3"><a style="font-size: 30px;" href="#test3">超越</a></li>
                            ...
                            <div id="test1" class="col s12">
                                <?php
                                    ...
                                    while ($row = $mysqli_result->fetch_array(MYSQLI_ASSOC)) {
                                        ...
                                        ?>
                                        <button type="button" class="layui-btn layui-btn-warm"><a  style="font-size: 30px;" style="font-size: 30px;" href="<?php echo $url;?>">预习视频</a></button>
