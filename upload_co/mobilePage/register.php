            ...
            <form class="layui-form layui-form-pane" action="../phome/index.php" method="post" onsubmit="return checkAll();">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input style="width:265px;" type="text" name="username" lay-verify="required" placeholder="请输入用户名" autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input style="width:265px;" type="password" name="password" id="pwd" placeholder="请输入密码" autocomplete="off" class="layui-input" onblur="checkPwd();">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input style="width:265px;" type="password" name="repassword" id="pwd_again" placeholder="请核对密码" autocomplete="off" class="layui-input" onblur="checkPwdAgain()">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input style="width:265px;" type="text" name="email" id="email" placeholder="请输入邮箱" autocomplete="off" class="layui-input" onblur="checkEmail();">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input style="width:265px;" type="text" name="key" id="key" placeholder="请输入验证码" autocomplete="off" class="layui-input" onblur="checkEmail();">
                    </div>
...
<!--                    <div class="layui-form-mid layui-word-aux" id="check_email">验证码</div>-->
                ...
                <div class="layui-form-item" pane="">
                    ...
                    <div class="layui-input-block">
                        <input style="width:265px;" type="radio" name="userSex" value="男" title="男" checked="" />
                        <input style="width:265px;" type="radio" name="userSex" value="女" title="女" />
                    </div>
                </div>
