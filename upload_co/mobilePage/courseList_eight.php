            ...
            <div class="col-md-12 col-sm-6" style="overflow-y: auto; overflow-x: auto; width: 100%; height: 100%;">
                <div class="card">
                    <div class="card-content">
                        <div class="col">
                            <ul class="tabs">
                                <li class="tab col s3"><a href="#test1" style="font-size:28px;">第一单元</a></li>
                                <li class="tab col s3"><a href="#test2" style="font-size:28px;">第二单元</a></li>
                                <li class="tab col s3"><a href="#test3" style="font-size:28px;">第三单元</a></li>
                                <li class="tab col s3"><a href="#test4" style="font-size:28px;">第四单元</a></li>
                                <li class="tab col s3"><a href="#test5" style="font-size:28px;">第五单元</a></li>
                                <li class="tab col s3"><a href="#test6" style="font-size:28px;">第六单元</a></li>
                                <li class="tab col s3"><a href="#test7" style="font-size:28px;">第七单元</a></li>
                                <li class="tab col s3"><a href="#test8" style="font-size:28px;">第八单元</a></li>
                                <li class="tab col s3"><a href="#test9" style="font-size:28px;">专题训练</a></li>
                                <li class="tab col s3"><a href="#test10" style="font-size:28px;">复习测试</a></li>
                            </ul>
                        </div>
