...
<form name="add" method="post" action="infophome.php" enctype="multipart/form-data">
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
    <tr class="header"> 
      <td height="25" colspan="2">增加视频 <input type=hidden name=softid value="<?=$softid?>"> 
        <input type=hidden name=phome value="<?=$phome?>"> <input type=hidden name=bclassid value="<?=$bclassid?>"> 
        <input type=hidden name=classid value="<?=$classid?>"> <input type=hidden name=tranpic value="<?=$r[tranpic]?>"> 
        <input type=hidden name=tranimg value="<?=$r[tranimg]?>">
        <input name="filepass" type="hidden" id="filepass" value="<?=$filepass?>"></td>
    </tr>
    <tr> 
      <td width="22%" height="25" bgcolor="#FFFFFF">影片名称：(*)</td>
    ...
    <tr> 
      ...
      <td height="25" bgcolor="#FFFFFF"> 界面语言： 
        <select name="language" id="language">
          <?=$l_options?>
        </select> <span class="style30">影片类型</span>： 
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF">使用播放器:</td>
      <td height="25" bgcolor="#FFFFFF"><select name="playerid" id="playerid">
          <option value="0">自动识别</option>
          <?=$player_class?>
        </select></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF">在线地址前缀:</td>
      <td height="25" bgcolor="#FFFFFF"><select name="conlineurl" id="conlineurl" onchange="document.add.onlineurl.value=this.value">
          <option>--</option>
          <?=$durl?>
        </select> <input name="onlineurl" type="text" size="60"> </td>
    </tr>
    <tr> 
      <td height="25" valign="top" bgcolor="#FFFFFF"> <p><strong>在线观看地址:</strong></p></td>
      <td height="25" bgcolor="#FFFFFF"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5">
                <tr> 
                  ...
                  <td width="40%">观看地址 
                    <input name="oeditnum" type="hidden" id="oeditnum" value="<?=$oeditnum?>"> 
                  </td>
                  <td width="21%"> <div align="center">权限</div></td>
                  <td width="13%"> <div align="center">点数</div></td>
                </tr>
          ...
          <tr> 
			...
			?>
              <table width="100%" border="0" cellspacing="1" cellpadding="3">
				<?
				for($si=1;$si<=$showonum;$si++)
				{
				?>
                <tr> 
                  <td width="5%"> <div align="center"><?=$si?></div></td>
                  <td width="18%"> <div align="left"> 
                      <input name="odownname[]" type="text" value="<?=$si?>" size="17">
                    </div></td>
                  <td width="50%"><select name=othedownqz[]><option value=''>--前缀--</option><?=$newdurl?></select><input name="odownpath[]" type="text" size="30" id=odownpath<?=$si?>><a href='#edown' onclick=SpOpenChFile(0,'odownpath<?=$si?>')>上传</a> / <a href='#edown' onclick=SpOpenChFilePath(0,'odownpath<?=$si?>')>选择</a> 
                  </td>
                  <td width="16%"><div align="center"> 
          ...
          <tr> 
            <td height="25">在线地址扩展数量: 
              <input name="odownnum" type="text" id="odownnum" value="1" size="6"> 
              <input type="button" name="Submit5" value="输出地址" onclick="javascript:dooadd();"></td>
          </tr>
          <tr> 
            <td id=addonline></td>
          </tr>
    ...
    <tr> 
      <td height="25" valign="top" bgcolor="#FFFFFF"><strong>影片介绍：</strong><br> 
        <br>
        UBB代码说明：<br>
        链接：[url]链接地址[/url]<br>
        图片：[img]图片地址[/img]<br>
