    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="intro.php">诚聪教育</a>
            </div>
...
<!--                        </ul>-->
    ...
    <iframe src="courseList_eight.php?grade_log=first_one&sub_log=chinese" width="100%" height="810px" frameborder="0" name="manList" scrolling="no"></iframe>
