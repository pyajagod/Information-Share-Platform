                ...
                <div class="col-md-11 col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="col">
                                <ul class="tabs">
                                    <li class="tab col s3"><a href="#test1">预习领先</a></li>
                                    <li class="tab col s3"><a href="#test2">复习巩固</a></li>
                                    <li class="tab col s3"><a href="#test3">拓展提优</a></li>
...
<!--                                            路径：--><?php //echo $row2['path_id'] ?>
                            ...
                            <div id="test4" class="col s12">
                                ...
                                while ($row3 = $mysqli_result3->fetch_array(MYSQLI_ASSOC)) {
                                    ...
                                    ?>
                                    <!--                                    <button type="button" class="layui-btn layui-btn-warm">扩展视频</button>-->
                                    <button type="button" class="layui-btn layui-btn-warm"><a  href="<?php echo $url3;?>">所有视频</a></button>
                                    <span class="lay_ex">
