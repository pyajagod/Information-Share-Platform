...
<body>
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>一年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">一年级（上）<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#">一年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 二年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">二年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">二年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 三年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">三年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">三年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 四年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">四年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">四年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="courseList_eight.php?grade_log=second_four&sub_log=chinese" target="manList">语文</a>
                                </li>
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 五年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">五年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">五年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="courseList_eight.php?grade_log=second_five&sub_log=chinese" target="manList">语文</a>
                                </li>
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 六年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">六年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">六年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="courseList_seven.php?grade_log=second_six&sub_log=chinese" target="manList">语文</a>
                                </li>
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 七年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">七年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">七年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 八年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">八年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">八年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 九年级<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">九年级（上）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                        ...
                        <li>
                            <a href="#">九年级（下）<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="col-md-12 col-sm-6" style="overflow-y: auto; overflow-x: auto; width: 100%; height: 700px;">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="col">
                            <ul class="tabs">
                                ...
                                <li class="tab col s3"><a href="#test1">第一单元</a></li>
                                <li class="tab col s3"><a href="#test2">第二单元</a></li>
                                <li class="tab col s3"><a href="#test3">第三单元</a></li>
                                <li class="tab col s3"><a href="#test4">第四单元</a></li>
                                <li class="tab col s3"><a href="#test5">第五单元</a></li>
                                <li class="tab col s3"><a href="#test6">第六单元</a></li>
                                <li class="tab col s3"><a href="#test7">第七单元</a></li>
                                <li class="tab col s3"><a href="#test8">第八单元</a></li>
                                <li class="tab col s3"><a href="#test9">第九单元</a></li>
                                <li class="tab col s3"><a href="#test10">第十单元</a></li>
                                <li class="tab col s3"><a href="#test11">第十一单元</a></li>
                                <li class="tab col s3"><a href="#test12">专题训练</a></li>
                                <li class="tab col s3"><a href="#test13">复习测试</a></li>
                            </ul>
                        </div>
                        ...
                        <div id="test1" class="col s12">
                            ...
                            $subLog = $_GET["sub_log"];
                            $sql1 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_one'";
                        ...
                        <div id="test2" class="col s12">
                            <?php
                            $sql2 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_two'";
                        ...
                        <div id="test3" class="col s12">
                            <?php
                            $sql3 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_three'";
                        ...
                        <div id="test4" class="col s12">
                            <?php
                            $sql4 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_four'";
                        ...
                        <div id="test5" class="col s12">
                            <?php
                            $sql5 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_five'";
                        ...
                        <div id="test6" class="col s12">
                            <?php
                            $sql6 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_six'";
...
//                            foreach ($rows as $row1) {
                        ...
                        <div id="test7" class="col s12">
                            <?php
                            $sql7 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_seven'";
                        ...
                        <div id="test8" class="col s12">
                            <?php
                            $sql8 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_eight'";
                        ...
                        <div id="test9" class="col s12">
                            <?php
                            $sql9 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_nine'";
                        ...
                        <div id="test10" class="col s12">
                            <?php
                            $sql10 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_ten'";
                        ...
                        <div id="test11" class="col s12">
                            <?php
                            $sql11 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'unit_eleven'";
                        ...
                        <div id="test12" class="col s12">
                            <?php
                            $sql13 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'special_training'";
                        ...
                        <div id="test13" class="col s12">
                            <?php
                            $sql14 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'synthetic_test'";
