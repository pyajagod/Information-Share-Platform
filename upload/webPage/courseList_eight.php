                    ...
                    <div class="card-content">
                        <div class="col">
                            <ul class="tabs">
                                ...
                                <li class="tab col s3"><a href="#test9">专题训练</a></li>
                                <li class="tab col s3"><a href="#test10">复习测试</a></li>
                            </ul>
                        </div>
...
<!--                                            </div>-->
                        ...
                        <div id="test9" class="col s12">
                            <?php
                            $sql9 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'special_training'";
//                            "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'special_training'"
                                    ...
                                    <div class="lay_con">
                                        <div class="lay_title">
                                            <div class="lay_title">
                                                ...
                                                $url9 = 'downloadPage2.php?'.http_build_query($query9);
                                                ?>
...
<!--                                            <div style="padding-left: 600px; margin-top: 5px">-->
<!--                                                <button type="button" class="layui-btn layui-btn-normal"><a-->
<!--                                                            style="color: #00FFFF" href="--><?php //echo $url9; ?><!--">查看详情</a>-->
<!--                                                </button>-->
<!--                                            </div>-->
                                        </div>
                                    </div>
                        ...
                        <div id="test10" class="col s12">
                            <?php
                            $sql10 = "SELECT * FROM ccxm_course WHERE grade_log='{$gradeLog}' AND sub_log = '{$subLog}' AND unit_log = 'synthetic_test'";
                                    ...
                                    <div class="lay_con">
                                        <div class="lay_title">
                                            <div class="lay_title">
                                                ...
                                                $url10 = 'downloadPage2.php?'.http_build_query($query10);
                                                ?>
...
<!--                                            <div style="padding-left: 600px; margin-top: 5px">-->
<!--                                                <button type="button" class="layui-btn layui-btn-normal"><a-->
<!--                                                            style="color: #00FFFF" href="--><?php //echo $url10; ?><!--">查看详情</a>-->
<!--                                                </button>-->
<!--                                            </div>-->
                                        </div>
                                    </div>
