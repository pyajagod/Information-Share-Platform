                    ...
                    <div class="card-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <tr class="odd gradeX">
                                    <td style="border-bottom: 0px">流程</td>
                                    <td style="font-size: 15px;font-weight: bold">1、注册账号</td>

                                </tr>
                                <tr class="odd gradeX">

                                    <td style="border:0px"></td>
                                    <td style="font-size: 15px;font-weight: bold">2、方案一：扫码加微信并验证微信号：chengcongjiaoyu 进行转账或扫描下方支付二维码进行直接充值</td>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td style="border:0px"></td>
                                    <td>账号：<img src="../imgs/boss.jpg"  style="width: 200px;height:200px">
                                        支付二维码：<img src="../imgs/pay.png"  style="width: 200px;height:200px"></td>

                                </tr>
                                <tr class="odd gradeX">

                                    <td style="border:0px"></td>
                                    <td style="font-size: 15px;font-weight: bold">       方案二：扫码加支付宝并验证支付宝号：18005176892 进行转账或扫描下方支付二维码进行直接充值</td>

                                </tr>
                                <tr class="odd gradeX">

                                    <td style="border:0px"></td>
                                    <td>账号：<img src="../imgs/aliboss.jpg"  style="width: 200px;height:200px">
                                        支付二维码：<img src="../imgs/alipay.png"  style="width: 200px;height:200px"></td>

                                </tr>
                                <tr class="odd gradeX">

                                    <td style="border:0px"></td>
                                    <td style="font-size: 15px;font-weight: bold">3、充值成功，在微信中让客服人员给充值账号直接加点</td>
                    ...
                    <div class="card-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <tr class="odd gradeX">
                                    <td style="border-bottom: 0px">诚聪币免费获取方式</td>
                                    <td>1、注册加微信后转发微信朋友圈，30分钟后截图即可获得30点</td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>1500</td>
                                    <td>2100</td>
                                    <td class="center">专建网盘</td>
                                </tr>
                                <tr class="odd gradeX">
                                    <td style="border-bottom: 0px">同步+专题</td>
                                    <td>2000</td>
                                    <td>3000</td>
                                    <td class="center"></td>
                                </tr>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>5000</td>
                                    <td>8500</td>
                                    <td class="center">专建网盘+精致学习视频</td>
                                </tr><tr class="odd gradeX">
                                    <td style="border-bottom: 0px">个性</td>
                                    <td>8000</td>
                                    <td>14400</td>
                                    <td class="center"></td>
                                </tr>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>20000</td>
                                    <td>40000</td>
                                    <td class="center">专建网盘+个性精致学习视频</td>
                                </tr>
